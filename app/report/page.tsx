...
export default function ReportPage() {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      const prompt = `You are an expert in waste food management and donation. Analyze this image and provide:
        1. The type of food  (e.g., raw, cooked, fresh, veg, non-veg)
        2. An estimate of the quantity or amount of food (in servings)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const formattedReport = {
        ...
        wasteType: report.foodType,
        amount: report.amount,
        createdAt: report.createAt.toISOString().split('T')[0]
      };
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <h1 className="text-3xl font-semibold mb-6 text-gray-800">Report food</h1>
